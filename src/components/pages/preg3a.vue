    ...
    <div class="titulo_escenario">
      <div class="subtitle">
        ...
        <p>
          ...
          trasladarse de manera segura. ¿Puedes entender y trazar el camino propuesto por Pacman?
          <br />
          <br />
          ...
          <br />
          <br />
          <strong>No te olvides de “Probar tu solución” antes de guardar solución.</strong>
        </p>
      </div>
      ...
      <div class="modal modalFour" v-if="modalIsActiveFo">
        <div class="submodal">
          <modal-four setModalFo="setModalFo"
            ><button class="btn_model" @click="setModalFo">Cerrar</button></modal-four
          >
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    pasarPregunta() {
      this.$router.replace({ name: "Pregunta3b" });
    },
    sendRow() {
      ...
      const data = { pregunta6: resultados };
