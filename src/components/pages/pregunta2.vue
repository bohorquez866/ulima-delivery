  ...
  <div class="big_container">
    <div class="titulo_escenario">
      <div class="subtitle">
        <h1>Pregunta 2</h1>
        <p>
          Al siguiente día, Pacman y Carita Feliz tienen examen de Lenguaje, pero Pacman recordó que
          había olvidado recoger su libro en su casa; por lo que ambos retornan a su casa. Traza un
          camino para que ambos lleguen a tiempo al colegio luego de recoger la tarea de Pacman.
          <br />
          <br />
    ...
    <div class="over_canvas">
      ...
      <div class="text_sect">
        ...
        <div class="idp">
          <div class="question_logo">
            <img src="../../assets/AvisosDeRespuesta/i03.png" alt="Sustentar solución" />
        ...
        <!-- <div class="video">
          <h4>Cómo realizar esta pregunta:</h4>
        ...
        <div class="div_button_next">
          <button class="btn_model next_btn_fol" @click="submit">
            <router-link class="ro_in" :to="{ name: 'Pregunta3' }">Siguiente</router-link>
          </button>
        </div>
      </div>
    </div>
