  ...
  <div class="big_container">
    <div class="titulo_escenario">
      <div class="subtitle">
        ...
        <p>
          Una vez descubierto el patrón de desplazamiento del fantasma, ¿Puedes ayudarlos a generar una instrucción uniendo bloques de tal manera que al seguir la secuencia pueda llegar a la academia?
          <br />
          <br />
      ...
      <div class="modal modalThree" v-if="modalIsActive">
        <div class="submodal">
          <modal-three setModal="setModal"
            ><button class="btn_model" @click="setModal">Cerrar</button></modal-three
          >
        </div>
      </div>
      ...
      <div class="modal floatingModal" v-if="modalIsActiveF">
        <div class="submodal">
          <floating-modal setModalF="setModalF"
            ><button class="btn_model" @click="setModalF">Cerrar</button></floating-modal
          >
        </div>
      </div>
    </div>
    ...
    <v-row>
      <v-col class="col_for_margin">
        <v-card width="500px" height="600px" id="bloque2" style="border-radius: 20px">
      ...
      <v-col>
        <v-card width="700px" height="600px" id="bloque2" style="border-radius: 20px"> </v-card>
        <div class="tag_for_space">
          <h3>Espacio 2</h3>
        </div>
      </v-col>
    ...
    <div class="div_button_save_sol">
      <div class="solutions">
        ...
        <v-btn class="btn_model" id="probar" v-on:click="guardarSolucion">
          Guardar solucion
        </v-btn>
      </div>
...
export default {
  ...
  methods: {
    ...
    pasarPregunta() {
      this.$router.replace({ name: "Pregunta3a" });
    },
    sendRow() {
      var V = [];
      V.push({ id: 11 });
