  ...
  <div class="big_container">
    <div class="titulo_escenario">
      <div class="subtitle">
        <h1>Pregunta 1</h1>
        <p>
          El lunes, Pacman y la Carita Feliz tienen examen de matemática. Traza un camino para que ambos lleguen a tiempo al colegio.
          <br />
          <br />
      ...
      <!-- Moviendo escenarios -->
      <!-- <v-slot class="logout">logout</v-slot> -->
    </div>
      ...
      <div class="left_box">
        ...
        <div class="div_button_save_sol">
          <!-- <button class="btn_model">
            <router-link class="ro_in" :to="{ name: 'IntroEscenario1' }">Volver</router-link>
          </button> -->
      ...
      <div class="text_sect">
        ...
        <div class="div_button_next">
          <button class="btn_model next_btn_fol" @click="submit">
            <router-link class="ro_in" :to="{ name: 'Pregunta2' }">Siguiente</router-link>
          </button>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    sendRow: function() {
      ...
      doc.loadInfo();
      // const sheet2 = doc.sheetsByTitle[this.id]; ELIMINAR
      ...
      // const moreRows = sheet2.addRows(this.respuestas); ELIMINAR

      // console.log(moreRows); ELIMINAR
