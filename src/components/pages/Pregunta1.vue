<template>
  <div class="big_container">
    ...
    <div class="over_canvas">
      <div class="left_box">
        ...
        <div class="div_button_save_sol">
          ...
          <button v-if="!list.length" class="btn_model" @click="showModal">
            Guardar Solución
          </button>
          <button
            v-else
      ...
      <div class="text_sect">
        ...
        <div class="div_button_next">
          <button
            ...
            @click="submit"
          >
            <router-link class="ro_in" :to="{ name: 'Pregunta2' }">
              Siguiente
            </router-link>
          </button>
        </div>
    ...
    <Modal ref="modal">
      <h2>Aviso</h2>
      <p>
        ¿Está seguro de guardar sin llenar los aspectos importantes?
      </p>
      <div>
