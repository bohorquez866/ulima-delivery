  ...
  <div class="considerations_container">
    ...
    <div class="list_considerations">
      ...
      <li>
        ...
        No hay un tiempo límite para entregar el test. Sin embargo, una vez
        iniciado, no podrás salir de la evaluación.
      </li>
      ...
      <li class="inline_li_ele">
        ...
        Recuerda leer todos los escenarios e identificar los
        <strong class="a_r">&nbsp;Avisos de Respuesta,&nbsp;</strong> los cuales
        te indican de forma complementaria la manera de presentar tu solución.
        Es obligatorio llenarlos.
      </li>
    ...
    <div class="avisosDeRespuesta">
      <div class="aviso">
        ...
        <p>
          Puedes responder a preguntas como: ¿Por qué no puedo lograr mi
          objetivo?, ¿Qué obstáculos se presentan?
        </p>
      </div>
      ...
      <div class="aviso">
        ...
        <p>
          A partir del entendimiento del problema, lista la mayor cantidad de
          aspectos que has considerado para tu solución
        </p>
      </div>
      ...
      <div class="aviso">
        ...
        <p>
          Escribe un pequeño párrafo que explique tu elección y/o solución.
          También puedes hacer una lista de los problemas resueltos.
        </p>
      </div>
    </div>

    <button class="btn_model">
      <router-link class="ro_in" :to="{ name: 'IntroEscenario1' }"
        >Iniciar</router-link
      >
    </button>
  </div>
