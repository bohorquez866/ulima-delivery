    ...
    <div class="big_container">
      <div class="titulo_escenario">
        <div class="subtitle">
          ...
          <p>
            Ambos han intentado los siguientes caminos, pero no han logrado llegar a la academia
            <strong>(ver imagen)</strong>. Con esta información, descubre el patrón de
            desplazamiento del fantasma rosado.
            <br />
            <br />
            ¿Quieres ver nuevamente el Escenario 2? <a @click="setModal">Ver escenario 2</a>
          </p>
        </div>
        ...
        <div class="text_sect">
          ...
          <div class="div_button_next">
            <button class="btn_model next_btn_fol" @click="submit">
              <router-link class="ro_in" :to="{ name: 'Pregunta2b' }">Siguiente</router-link>
            </button>
          </div>
        </div>
