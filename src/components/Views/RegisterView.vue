  ...
  <div class="superior_container">
    <form action="#" @submit.prevent="submitRegister" class="formulario">
      ...
      <div class="names_div">
        ...
        />
        <input class="last" type="text" placeholder="Last Name" v-model="formData.lastName" />
      </div>
      ...
      <div class="selections">
        <p>¿Cuentas con experiencia?</p>
        <div class="selection_box">
          <div class="select">
            <select v-model="formData.Computing">
              <option :value="'Computing'" disabled selected>Computación</option>
          ...
          <div class="select">
            <select v-model="formData.Programing">
              <option :value="'Programing'" disabled selected>Programación</option>
              <option>Ninguna</option>
              <option>Básico</option>
              <option>Intermedio</option>
              <option>Avanzado</option>
      ...
      <div>
        <input class="inputs_form" type="email" placeholder="Email" v-model="email" />
        <input class="inputs_form" type="password" placeholder="Password" v-model="password" />
      </div>
      <p>{{ error }}</p>

      <div class="check-terms">
        <input type="checkbox" name="terms and conditions" id="" required="true" class="check" />
      ...
      <p class="have-account">
        Ya tienes cuenta? <router-link :to="{ name: 'Login' }">Log in</router-link>
      </p>
    </form>
  </div>
</template>
