...
export function setSub02(data) {
  ...
  let IM =
    pregunta2 && pregunta1 ? getIndiceMejora(pregunta2, pregunta1, 24) : 10;
  ...
  if (pregunta5 && pregunta5p2 && pregunta6p3) {
    if (
      ...
      (pregunta5[0]["cumplio"] == "si" &&
        pregunta5p2[0]["cumplio"] == "si" &&
        pregunta6p3[0]["respElegida"] == "misol")
    ) {
      dict["2c"] = 1;
    }
    if (
      pregunta5[0]["cumplio"] == "si" &&
      (pregunta6p3[0]["respElegida"] == "carita" ||
        pregunta6p3[0]["respElegida"] == "pacman")
    ) {
      dict["2c"] = 3;
    }
    if (
...
export function setSub03(data) {
  ...
  if (pregunta4) {
    ...
    else if (pregunta4[0]["cumplio"] == "si" && pregunta4[0]["errores"] >= 1)
      dict["2a"] = 3;
    else if (pregunta4[0]["cumplio"] == "si" && pregunta4[0]["errores"] == 0)
      dict["2a"] = 5;
  }
  ////////////// get 2b
  const pregunta5 = data["pregunta5"];
  if (pregunta5) {
    ...
    else if (pregunta5[0]["cumplio"] == "si" && pregunta4[0]["errores"] >= 1)
      dict["2b"] = 3;
    else if (pregunta5[0]["cumplio"] == "si" && pregunta4[0]["errores"] == 0)
      dict["2b"] = 5;
  }
  ////////////// get 2c
  ...
  if (pregunta6 && pregunta6p2) {
    if (pregunta6[0]["cumplio"] == "no" && pregunta6p2[0]["cumplio"] == "no")
      dict["2c"] = 1;
    else if (
...
function checkCumplioAndOptimo(pregunta) {
  if (pregunta) {
    if (pregunta.length == 0) {
      ...
      else if (solution["cumplio"] == "T" && solution["optima"] == "F")
        return 3;
      else if (solution["cumplio"] == "T" && solution["optima"] == "T")
        return 5;
    }
  } else {
    return 1;
...
export function setSub09(data) {
  ...
  if (pregunta6 && pregunta6p2) {
    ...
    if (
      pregunta6[0].cumplio == "si" &&
      pregunta6[0].errores <= 3 &&
      pregunta6p2[0].cumplio == "si" &&
      pregunta6p2[0].errores <= 3
    ) {
      dict["2c"] = 5;
    }
  }
